...
export function loadRayCastVehicle(snake){
  ...
  snake.utils.addObject("rearAxel");
  ...
  snake.utils.addObject("frontAxel");
  ...
  snake.utils.addObject("rearLWheel");
  ...
  snake.utils.addObject("rearRWheel");
  ...
  snake.utils.addObject("frontLWheel");
  ...
  snake.utils.addObject("frontRWheel");
