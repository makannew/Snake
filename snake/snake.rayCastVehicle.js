...
export function loadRayCastVehicle(snake){
  ...
  snake.sceneObjects.chassis={};
  snake.utils.addObject(snake.sceneObjects.chassis);
  ...
  snake.sceneObjects.cockPit={}
  snake.utils.addObject(snake.sceneObjects.cockPit);
  ...
  snake.sceneObjects.nose={};
  snake.utils.addObject(snake.sceneObjects.nose);
  ...
  snake.sceneObjects.rearLWheel={};
  snake.utils.addObject(snake.sceneObjects.rearLWheel);
  ...
  snake.sceneObjects.rearRWheel={};
  snake.utils.addObject(snake.sceneObjects.rearRWheel);
  ...
  snake.sceneObjects.frontLWheel={};
  snake.utils.addObject(snake.sceneObjects.frontLWheel);
  ...
  snake.sceneObjects.frontRWheel={};
  snake.utils.addObject(snake.sceneObjects.frontRWheel);
