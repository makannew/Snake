...
export function rotatingJupiter(
  obj,
  pos,
  quat,
  localPos = new THREE.Vector3(0, 0, 0),
...
export function rotatingMercury(
  obj,
  pos,
  quat,
  localPos = new THREE.Vector3(0, 0, 0),
...
export function rotatingHaumea(
  obj,
  pos,
  quat,
  localPos = new THREE.Vector3(0, 0, 0),
