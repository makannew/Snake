  ...
  let result = [
    ...
    },
    {
      ...
      obstacles: [
        {
          build: coneBarrier,
          localPos: { x: 2, y: 0.4, z: 10 },
          enablingDistance: 0,
          disablingDistance: 2,
        },
        {
          build: coneBarrier,
          localPos: { x: -5, y: 0.4, z: 0 },
          enablingDistance: 0,
          disablingDistance: 2,
        },
        {
          build: coneBarrier,
          localPos: { x: 5, y: 0.4, z: -10 },
          enablingDistance: 0,
          disablingDistance: 2,
        },
      ],
    ...
    },
    {
      obstacles: [
        ...
        {
          build: box,
          localPos: { x: -3, y: 3.4, z: 0 },
          enablingDistance: -1,
          disablingDistance: 3,
        },
        {
          build: box,
          localPos: { x: 0, y: 6.4, z: 0 },
          enablingDistance: -1,
          disablingDistance: 3,
        },
        {
    ...
    },
    {
      ...
      obstacles: [
        {
          build: rotatingEarth,
          localPos: { x: -3, y: 2, z: 10 },
          enablingDistance: -2,
          disablingDistance: 1,
        },
        {
          build: rotatingVenus,
          localPos: { x: 3, y: 2, z: 0 },
          enablingDistance: -2,
          disablingDistance: 1,
        },
        {
    ...
    },
    {
      ...
      obstacles: [
        {
          build: coneBarrier,
          localPos: { x: -3, y: 0.4, z: 0 },
          enablingDistance: -1,
          disablingDistance: 1,
        },
        {
          build: rotatingJupiter,
          localPos: { x: -3, y: 2, z: 10 },
          enablingDistance: -1,
          disablingDistance: 1,
        },
        {
          build: rotatingMercury,
          localPos: { x: 3, y: 2, z: 0 },
          enablingDistance: -1,
          disablingDistance: 1,
        },
        {
          build: rotatingHaumea,
          localPos: { x: -3, y: 2, z: -10 },
          enablingDistance: -1,
          disablingDistance: 1,
        },
    ...
    },
    {
      ...
      plot: (rGame) => {
        if (rGame.framesInterval < maxAcceptableInterval) {
          if (rGame.roadTrains[0].visibleTrailers < 2)
            ++rGame.roadTrains[0].visibleTrailers;
    ...
    },
    {
      ...
      obstacles: [
        {
          build: barrel,
          localPos: { x: -2, y: 0.4, z: -4 },
          enablingDistance: 0,
          disablingDistance: 2,
        },
        {
          build: barrel,
          localPos: { x: 4, y: 0.4, z: 4 },
          enablingDistance: 0,
          disablingDistance: 2,
        },
      ],
    ...
    },
    {
      obstacles: [
        ...
        {
          build: barrel,
          localPos: { x: -3, y: 0.4, z: -5 },
          enablingDistance: -2,
          disablingDistance: 1,
        },
        {
          build: barrel,
          localPos: { x: -3, y: 0.4, z: -8 },
          enablingDistance: -2,
          disablingDistance: 1,
        },
      ],
    ...
    { left: slope * 3, offset: { x: 0, y: -0.05, z: 0 } },
    { right: slope * 2 },
    { right: slope * 2 },
